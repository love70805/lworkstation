...
实现 `70e20f9`、首页适配 `c6175e5` 和切店重复概览修订 `8fda4bc` / `bda43e8` 已审查集成。主线 99 文件 / 640 测试、build、12 组浏览器布局 / 日明细交互通过，desktop verify 通过；Windows 候选待构建验收。详见 [0.2.13 更新记录](RELEASE_0.2.13.md)。
