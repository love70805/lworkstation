...
- 阶段交付：人工/ERP/首页/安装向导/弹窗代码已承接准备分支，主线初次 release:check 与 desktop verify 通过；实际浏览器微小/零/跨店/撤销/定稿/重开和三尺寸首页验收通过。离线请求遗留修订及最终完整回归尚待完成；SQL 0012 文件和测试单独批准仍待答复。未生成正式候选、未合入受保护集成分支、未发布新版本。详见 [验收记录](RELEASE_0.2.10.md)。
