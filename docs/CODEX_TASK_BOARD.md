...
仅继续 Windows 桌面版。人工确认删除、备份一级入口、候选成本文案和人工填写流程已实现；审查修复冻结报告撤回被底层拒绝、旧参考审批误标人工成本等不一致。110 文件 / 717 测试通过，版本同步为 `0.3.0-beta`。桌面候选打包与实际交互验收进行中，未公开发布、未安装，真实数据未改。详见 [Beta 验收记录](RELEASE_0.3.0_BETA.md)。
