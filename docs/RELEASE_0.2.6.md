...
状态：用户于 2026-09-08 授权打包发布；正式包本地验收通过，待 GitHub 资产上传与回读，尚未标记公开发布。
...
- 证据归档：主仓库 `archive/release-0.2.6-2026-09-08/`，包含旧构建归档、构建/smoke/整理/发布检查日志、包检查记录及待上传四类资产。未对正式用户安装执行覆盖；不声称真实安装迁移或线上更新验收完成。
