...
内容脚本/MAIN world 只提交最小 1688 商品证据（商品名、来源链接、图片、SKU、数量、价格和采集警告）；不能提供 endpoint、token、workspace、member、owner、visibility 或 ACK 控制。工作区、成员和可见性仍由 Lworkstation active context 与服务端 contract 决定。
