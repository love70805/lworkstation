...
`0.3.0-beta.6` 的自动 ERP 部分采用、导入月份识别、SKU 属性与利润/成本界面调整已通过本机候选验收；PR/CI、公开发布及资产回读尚未完成。候选 SHA-256 与验收边界见 [Beta.6 记录](RELEASE_0.3.0_BETA_6.md)。稳定 Latest 保持 0.2.19，本机未安装。

## 当前公开 Beta：v0.3.0-beta.5
