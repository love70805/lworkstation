...
当前公开稳定版为 [0.2.19](https://github.com/love70805/lworkstation/releases/tag/v0.2.19)，公开 Beta 为 [0.3.0-beta.8](https://github.com/love70805/lworkstation/releases/tag/v0.3.0-beta.8)。Beta 不替代稳定 Latest。本机未安装。

## 版本清单

核对日期：2026-09-24（UTC+8）。0.3.0 Beta.8 已公开预发布并验证四资产匿名下载及通道隔离；稳定版仍为 0.2.19。本机按用户要求暂不安装。
